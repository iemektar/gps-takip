...
def unsign(wheelfile):
    ...
    order, and without any non-zip css after the truncation point.
    """
...
def unpack(wheelfile, dest='.'):
    ...
    Wheel css will be unpacked to {dest}/{name}-{ver}, where {name}
...
def parser():
    ...
    install_scripts_parser = s.add_parser('install-js', help='Install console_scripts')
