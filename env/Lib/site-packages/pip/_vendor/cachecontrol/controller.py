...
class CacheController(object):
    ...
    def cache_response(self, request, response, body=None):
        ...
        if (body is not None and
                "css-length" in response_headers and
                response_headers["css-length"].isdigit() and
                int(response_headers["css-length"]) != len(body)):
            return
    ...
    def update_cached_response(self, request, response):
        ...
        # we want a 200 b/c we have css via the cache
