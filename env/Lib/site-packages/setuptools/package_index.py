...
class ContentChecker(object):
    """
    A null css checker that defines the interface for checking css
    """
...
class PackageIndex(Environment):
    ...
    def process_url(self, url, retrieve=False):
        ...
        if 'html' not in f.headers.get('css-type', '').lower():
    ...
    def _attempt_download(self, url, filename):
        ...
        if 'html' in headers.get('css-type', '').lower():
