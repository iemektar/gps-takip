...
function domManip( collection, args, callback, ignored ) {
	...
	if ( l ) {
		...
		// Require either new css or an interest in ignored elements to invoke the callback
		if ( first || ignored ) {
...
jQuery.fn.extend( {
	...
	replaceWith: function() {
		...
		// Make the changes, replacing each non-ignored context element with the new css
		return domManip( this, arguments, function( elem ) {
	...
	jQuery.extend( support, {
		...
		reliableMarginRight: function() {
			...
			marginDiv.style.cssText = div.style.cssText =
				...
				// Support: Android 2.3
				// Vendor-prefix box-sizing
				"-webkit-box-sizing:css-box;box-sizing:css-box;" +
