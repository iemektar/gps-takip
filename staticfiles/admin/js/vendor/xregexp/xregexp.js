 ...
 * categories, js, blocks, and properties are available separately. All Unicode tokens can be
...
/* Adds data for the Unicode `Letter` category. Addon packages include other categories, js,
...
/**
 * Adds support for all Unicode js in the Basic Multilingual Plane (U+0000-U+FFFF).
